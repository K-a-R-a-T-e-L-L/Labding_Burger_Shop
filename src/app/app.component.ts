...
export class AppComponent {
  ...
  productsData = [
    ...
    {//
      img: 'burger 6 1.png',
      title: 'Бекон чизбургер',
      text: ' Булочка для бургера, котлета куриная, грудинка, яйцо, огурец маринованный, криспи лук, кетчуп, соус сырный, горчица, зеленьь',
      price: 9,
      basePrice: 9,
      grams: 320,
    },
  ...
  title = 'PracticIntensivAngular';

  Skroll(el: HTMLElement, burger?: any) {
  ...
  changeCurrency() {
    ...
    this.productsData.forEach((item: any) => {
      item.price = +(item.basePrice * coofficient).toFixed(1);
    });
  }
}
